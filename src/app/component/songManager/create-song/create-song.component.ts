...
export class CreateSongComponent implements OnInit {
  ...
  song: Partial<Song>;
  song: { nameSong: string; singer: { nameSinger: string; id: string }; avatarUrl: string; category: string; mp3Url: string; lyrics: string; describes: string };
